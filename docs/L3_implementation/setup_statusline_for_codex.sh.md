...
根拠: `setup_statusline_for_codex.sh:1-10`
...
根拠: `setup_statusline_for_codex.sh:6-93`
...
根拠: `setup_statusline_for_codex.sh:15-91`, `install.sh:108-109`

## 統合ポイント

- caller: `install.sh`
- standalone entry point: `./setup_statusline_for_codex.sh`
